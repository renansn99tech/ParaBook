...
# A política só passa a exigir declaração após publicação autorizada de Termos,
# Privacidade e RIPD. O marco é único para contas existentes; contas posteriores
# usam o próprio date_joined (ver usuarios.idade.prazo_declaracao).
