...
function MinhasConquistas() {
      ...
      <main className="container py-5" style={{ minHeight: '70vh' }}>
        <div className="text-center mb-4">
          <h1 className="fw-bold text-white mb-2">
            <i className="fa-solid fa-award me-2" style={{ color: '#8b5cf6' }}></i>
        ...
        <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
          {Array.from({ length: 6 }).map((_, i) => (
            <div className="col" key={i}>
              <div className="card h-100 border-0 shadow-lg rounded-4" style={{ background: '#12131C', border: '1px solid rgba(255,255,255,0.05)' }}>
                <div className="card-body p-4 d-flex align-items-start gap-3">
                  <Skeleton variant="avatar" width="58px" height="58px" />
                  <div className="flex-grow-1">
                    <Skeleton variant="text" width="90px" height="20px" style={{ borderRadius: 'var(--radius-pill)', marginBottom: '10px' }} />
  ...
  return (
    <main className="container py-5" style={{ minHeight: '70vh' }}>
      ...
      {resumo && (
        <div className="card border-0 shadow-lg rounded-4 text-white mb-5" style={{ background: '#12131C' }}>
          <div className="card-body p-4">
            ...
            <div className="progress" style={{ height: '10px', background: 'rgba(255,255,255,0.08)' }} role="progressbar"
                 aria-label="Progresso das conquistas" aria-valuenow={percentual} aria-valuemin="0" aria-valuemax="100">
              <div
                className="progress-bar"
                style={{ width: `${percentual}%`, background: 'linear-gradient(90deg, #8b5cf6, #60a5fa)' }}
              ></div>
            </div>
        ...
        <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
          {conquistas.map((conquista) => (
            <div className="col" key={conquista.id}>
              <div
                className="card h-100 border-0 shadow-lg rounded-4 text-white"
                style={{
                  background: '#12131C',
                  border: conquista.desbloqueada ? '1px solid rgba(34,197,94,0.35)' : '1px solid rgba(255,255,255,0.05)',
                  opacity: conquista.desbloqueada ? 1 : 0.65
                }}
              >
                <div className="card-body p-4 d-flex align-items-start gap-3">
                  <div
                    ...
                    style={{
                      ...
                      height: '58px',
                      fontSize: '1.4rem',
                      background: conquista.desbloqueada ? 'rgba(34,197,94,0.2)' : 'rgba(255,255,255,0.06)',
                      color: conquista.desbloqueada ? '#86efac' : '#94a3b8'
                    }}
                  >
                  ...
                  <div className="flex-grow-1">
                    <span
                      ...
                      style={{
                        background: conquista.desbloqueada ? 'rgba(34,197,94,0.2)' : 'rgba(255,255,255,0.08)',
                        color: conquista.desbloqueada ? '#86efac' : '#cbd5e1'
                      }}
                    >
                    ...
                    <div className="d-flex flex-wrap align-items-center gap-2">
                      <small className="fw-bold" style={{ color: '#86efac' }}>
